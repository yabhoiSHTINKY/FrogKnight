...
public class ContfrogPower() : FrogKnightPower
{
    ...
    public override string CustomPackedIconPath => "res://FrogKnight/images/powers/grabble.png";
    public override string CustomBigIconPath => "res://FrogKnight/images/powers/grabble.png";
